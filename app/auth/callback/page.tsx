        ...
        const handleCallback = async () => {
            try {
                ...
                if (data.session) {
                    ...
                    // If no session immediately, consider checking hash manually or waiting
                    // But usually getSession handles it if PKCE is correct
                    // For now, if no session, just redirect to login
