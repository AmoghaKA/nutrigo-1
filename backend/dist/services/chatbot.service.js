    ...
    async loadKnowledgeBase() {
        try {
            ...
            const possiblePaths = [
                ...
                path_1.default.join(__dirname, '../../knowledge-base'),
                path_1.default.join(__dirname, '../../../knowledge-base'),
                path_1.default.join(process.cwd(), 'src/knowledge-base'),
                path_1.default.join(process.cwd(), 'knowledge-base'),
                path_1.default.join(process.cwd(), 'backend/knowledge-base'),
                path_1.default.join(process.cwd(), 'backend/src/knowledge-base'),
                path_1.default.join(process.cwd(), 'dist/knowledge-base'),
            ];
...
A: NutriGo provides detailed nutritional information, health scores, ingredient analysis, allergen warnings, and suggests healthier alternatives.
        `;
            ...
            const files = await promises_1.default.readdir(knowledgePath);
